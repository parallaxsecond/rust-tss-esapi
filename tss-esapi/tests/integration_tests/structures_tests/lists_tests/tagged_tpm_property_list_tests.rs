...
fn test_valid_conversions() {
    let expected_tagged_properties: Vec<TaggedProperty> = vec![
        TaggedProperty::new(
            PropertyTag::PrimitivePropertyTag(PrimitivePropertyTag::FamilyIndicator),
            8u32,
        ),
        TaggedProperty::new(
            PropertyTag::PrimitivePropertyTag(PrimitivePropertyTag::Level),
            12u32,
        ),
        TaggedProperty::new(
            PropertyTag::PrimitivePropertyTag(PrimitivePropertyTag::HrLoadedMin),
            24u32,
        ),
    ];
    ...
    assert!(
        tagged_tpm_property_list
            .find(PropertyTag::PrimitivePropertyTag(
                PrimitivePropertyTag::AlgorithmSet
            ))
            .is_none(),
