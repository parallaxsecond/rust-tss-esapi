...
use tss_esapi::{
    ...
    constants::{
        ...
        tss::{
            ...
            TPM2_PT_HR_ACTIVE, TPM2_PT_HR_ACTIVE_AVAIL, TPM2_PT_HR_LOADED, TPM2_PT_HR_LOADED_AVAIL,
            TPM2_PT_HR_LOADED_MIN, TPM2_PT_HR_NV_INDEX, TPM2_PT_HR_PERSISTENT,
            TPM2_PT_HR_PERSISTENT_AVAIL, TPM2_PT_HR_PERSISTENT_MIN, TPM2_PT_HR_TRANSIENT_AVAIL,
            TPM2_PT_HR_TRANSIENT_MIN, TPM2_PT_INPUT_BUFFER, TPM2_PT_LEVEL,
            TPM2_PT_LIBRARY_COMMANDS, TPM2_PT_LOADED_CURVES, TPM2_PT_LOCKOUT_COUNTER,
            TPM2_PT_LOCKOUT_INTERVAL, TPM2_PT_LOCKOUT_RECOVERY, TPM2_PT_MANUFACTURER,
            TPM2_PT_MAX_AUTH_FAIL, TPM2_PT_MAX_CAP_BUFFER, TPM2_PT_MAX_COMMAND_SIZE,
            TPM2_PT_MAX_DIGEST, TPM2_PT_MAX_OBJECT_CONTEXT, TPM2_PT_MAX_RESPONSE_SIZE,
            TPM2_PT_MAX_SESSION_CONTEXT, TPM2_PT_MEMORY, TPM2_PT_MODES, TPM2_PT_NONE,
            TPM2_PT_NV_BUFFER_MAX, TPM2_PT_NV_COUNTERS, TPM2_PT_NV_COUNTERS_AVAIL,
            ...
            TPM2_PT_STARTUP_CLEAR, TPM2_PT_TOTAL_COMMANDS, TPM2_PT_VENDOR_COMMANDS,
