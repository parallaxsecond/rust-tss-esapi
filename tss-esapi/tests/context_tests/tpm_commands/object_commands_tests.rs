...
mod test_load_external {
    ...
    use tss_esapi_sys::{
        TPM2B_PRIVATE_KEY_RSA, TPM2B_SENSITIVE, TPMT_SENSITIVE, TPMU_SENSITIVE_COMPOSITE,
    };
    ...
    const PRIV_KEY: [u8; 256] = [
        ...
        0x28, 0x4c, 0xbe, 0xbd, 0xb9, 0x80, 0x54, 0xed, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    pub fn get_ext_rsa_priv() -> TPM2B_SENSITIVE {
        TPM2B_SENSITIVE {
            size: std::mem::size_of::<TPM2B_SENSITIVE>() as u16,
            sensitiveArea: TPMT_SENSITIVE {
                sensitiveType: PublicAlgorithm::Rsa.into(),
