...
use crate::constants::tss::{
    TPM2_RC_AUTH_CONTEXT, TPM2_RC_AUTH_MISSING, TPM2_RC_AUTH_TYPE, TPM2_RC_AUTH_UNAVAILABLE,
    TPM2_RC_AUTHSIZE, TPM2_RC_BAD_CONTEXT, TPM2_RC_COMMAND_CODE, TPM2_RC_COMMAND_SIZE,
