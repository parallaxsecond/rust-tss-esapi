...
pub enum CommandCode {
    ...
    CertifyX509 = CommandCodeStructure::CERTIFY_X509.0,
    ActSetTimeout = CommandCodeStructure::ACT_SET_TIMEOUT.0,
    EccEncrypt = CommandCodeStructure::ECC_ENCRYPT.0,
    EccDecrypt = CommandCodeStructure::ECC_DECRYPT.0,
    PolicyCapability = CommandCodeStructure::POLICY_CAPABILITY.0,
    PolicyParameters = CommandCodeStructure::POLICY_PARAMETERS.0,
    NvDefineSpace2 = CommandCodeStructure::NV_DEFINE_SPACE_2.0,
    NvReadPublic2 = CommandCodeStructure::NV_READ_PUBLIC_2.0,
    SetCapability = CommandCodeStructure::SET_CAPABILITY.0,
    ReadOnlyControl = CommandCodeStructure::READ_ONLY_CONTROL.0,
    PolicyTransportSpdm = CommandCodeStructure::POLICY_TRANSPORT_SPDM.0,
    VerifySequenceComplete = CommandCodeStructure::VERIFY_SEQUENCE_COMPLETE.0,
    SignSequenceComplete = CommandCodeStructure::SIGN_SEQUENCE_COMPLETE.0,
    VerifyDigestSignature = CommandCodeStructure::VERIFY_DIGEST_SIGNATURE.0,
    SignDigest = CommandCodeStructure::SIGN_DIGEST.0,
    Encapsulate = CommandCodeStructure::ENCAPSULATE.0,
    Decapsulate = CommandCodeStructure::DECAPSULATE.0,
    VerifySequenceStart = CommandCodeStructure::VERIFY_SEQUENCE_START.0,
    SignSequenceStart = CommandCodeStructure::SIGN_SEQUENCE_START.0,
}
