...
impl std::fmt::Display for BaseReturnCode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self.base_error {
            ...
            BaseError::BadTctiStructure => write!(f, "Bad TCTI Strucutre"),
            ...
            BaseError::SignatureVerificationFailed => write!(f, "Signature Verfication Failed"),
            ...
            BaseError::PcrNotResettable => write!(f, "PCR Not Recettable"),
