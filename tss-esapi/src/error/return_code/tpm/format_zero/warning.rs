...
use crate::{Error, Result, constants::return_code::TpmFormatZeroWarning};
...
impl std::fmt::Display for TpmFormatZeroWarningResponseCode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        match self.error_number {
            ...
            TpmFormatZeroWarning::Memory => write!(
                f,
            ...
            TpmFormatZeroWarning::Yielded => write!(
                f,
            ...
            TpmFormatZeroWarning::NvUnavailable => write!(
                f,
