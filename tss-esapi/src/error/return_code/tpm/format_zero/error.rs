...
use crate::{Error, Result, constants::return_code::TpmFormatZeroError};
...
impl std::fmt::Display for TpmFormatZeroErrorResponseCode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self.error_number {
            TpmFormatZeroError::Initialize => write!(
                f,
                "TPM not initialized by TPM2_Startup or already initialized."
            ),
            TpmFormatZeroError::Failure => {
                write!(f, "Commands not accepted because of a TPM failure.")
            }
            ...
            TpmFormatZeroError::Upgrade => write!(
                f,
            ...
            TpmFormatZeroError::CommandSize => write!(
                f,
            ...
            TpmFormatZeroError::AuthSize => write!(
                f,
            ...
            TpmFormatZeroError::AuthContext => write!(
                f,
            ...
            TpmFormatZeroError::NvSize => {
                write!(f, "Requested allocation size is larger than allowed.")
            }
            TpmFormatZeroError::NvLocked => write!(f, "NV access locked."),
            TpmFormatZeroError::NvAuthorization => {
                write!(f, "NV access authorization fails in command actions.")
            }
            TpmFormatZeroError::NvUninitialized => write!(
                f,
            ...
            TpmFormatZeroError::NvDefined => {
                write!(f, "NV Index or persistent object already defined.")
            }
            TpmFormatZeroError::BadContext => {
                write!(f, "Context in TPM2_ContextLoad() is not valid.")
            }
            TpmFormatZeroError::CpHash => {
                write!(f, "`cpHash` value already set or not correct for use.")
            }
            ...
            TpmFormatZeroError::NoResult => write!(
                f,
            ...
            TpmFormatZeroError::Sensitive => write!(
                f,
